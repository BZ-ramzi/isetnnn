  ...
  <li class="toolbar-icon-bg hidden-xs">
	...
	<ul class="acc-menu">
		...
		<ul class="acc-menu">
				...
				<li><a href="">Personnel du Ci</a></li>
						...
						<ul class="acc-menu">
				<li><a href="">Création - Activation</a></li>
				<li><a href="">Changer le mot de passe</a></li>
				<li><a href="">Règles pour le mot de passe</a></li>
				<li><a href="">Blocage - fermeture</a></li>
		...
		<li><a href="javascript:;"><i class="ti  ti-signal"></i><span>Réseau Wi-Fi</span></a>
			<ul class="acc-menu">
				<li><a href="">Accès au réseau sans fil</a></li>
				<li><a href="">Règles d'utilisation du wifi</a></li>

				
					
			</ul>
		</li>
				<li><a href=""><i class="ti ti-printer"></i><span>Impression</span></a>
				...
				<li><a href=""><i class="ti ti-email"></i><span>Mail/Agenda</span></a>
				
			</li>
				<li><a href=""><i class="ti ti-files"></i><span>Documentation</span></a>
		...
		<li><a href="#"><i class="ti ti-help"></i><span>Help desk</span></a>
