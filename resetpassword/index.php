				...
				<div class="tab-pane active" id="tab-about">
					<div class="panel panel-default">
						...
						<div class="panel-body">
						  ...
						  <form action="../scripts/reset_pwd.php" method="post">
							<div class="form-group">
											<label for="form-password" class="col-sm-4 control-label">Mot de passe</label>
											<div class="col-sm-8 tabular-border">
											<input type="text" style="display:none;" value="<?php echo $_SESSION['id_entreprise']; ?>" name="id_ent">
												<input type="password" class="form-control" required name="pwd" onChange="form.confirmpass.pattern = this.value;"  placeholder="Mot de passe">
											</div>
										</div>
										<br><br>
										<div class="form-group">
											<label for="form-confirmpass" class="col-sm-4 control-label">Confirmation mot de passe</label>
											<div class="col-sm-8 tabular-border">
												<input type="password" class="form-control" required id="confirmpass" placeholder="Confirmation mot de passe">
											</div>
										</div>
